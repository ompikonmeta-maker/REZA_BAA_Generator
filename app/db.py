...
DEFAULT_PHOTO_CATEGORIES = [
    ...
    {"key": "sn_kit", "label": "Foto SN Kit Starlink", "ocr": True, "keywords": ["sn_kit", "snkit", "kit"]},
    {"key": "sn_router", "label": "Foto SN Router", "ocr": True, "keywords": ["sn_router", "snrtr", "router"]},
    {"key": "sn_ap", "label": "Foto SN Access Point", "ocr": True, "keywords": ["sn_ap", "sn_access", "accesspoint", "access_point"]},
